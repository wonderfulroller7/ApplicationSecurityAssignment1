...
#    @weight(2)
    ...
    #     testfile = "test1.txt"
    #     testsub = subprocess.Popen(["./spell_check", testfile, DICTFILE], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
#    @weight(2)
    ...
    #     log= logging.getLogger( "TestCasesAssignment1.test_arrival_sstf" )
    #     testfile = "test3.txt"
    #     testsub = subprocess.Popen(["./spell_check", testfile, DICTFILE], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    #         self.assertTrue(thing.lower() in expected, msg='{0} {1}'.format(failmsg, output))
    #     testsub.terminate()
    ...
    #     testfile = "test9.txt"
    #     testsub = subprocess.Popen(["./spell_check", testfile, BADDICT], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    #     err_output = testsub.stderr.read().decode()
    #     output = testsub.stdout.read().decode().strip().split('\n')
    #     code = testsub.wait()
